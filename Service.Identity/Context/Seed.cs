    ...
    public class Seed
    {
        ...
        private static List<Menu> GetMenus()
        {
            var menus = new List<Menu>
            {
                ...
                new Menu(25, 24, "Toma de muestra", "sampling", "samplings", 2405),
                new Menu(26, 24, "Solicitar Estudio", "requestedstudy", "requestedstudy", 2406),
                ...
                new Menu(32, 24, "Búsqueda y envío de resultados", "deliveryResults","deliveryResults", 100),
