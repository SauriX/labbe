...
namespace Service.Identity.Mapper
{
    ...
    {
        public static List<Permission> toPermission(UserFormDto rolForm, Guid iduser, string token, List<MenuDto> menus)
        {
            string jwt = token;
        ...
        public static List<Permission> toEditPermission(List<UserPermissionDto> rolForm, Guid iduser, string token, List<MenuDto> menus, string idpermiso)
        {
            string jwt = token;
            JwtSecurityTokenHandler tokenHandler = new JwtSecurityTokenHandler();
            var securityToken = (JwtSecurityToken)tokenHandler.ReadToken(jwt);
