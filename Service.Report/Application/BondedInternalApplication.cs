...
{
    public class BondedInternalApplication : BaseApplication, IBondedRequestApplication
    {
        public readonly IReportRepository _repository;
        private readonly IPdfClient _pdfClient;

        public BondedInternalApplication(IReportRepository repository, IPdfClient pdfClient, IRepository<Branch> branchRepository, IRepository<Medic> medicRepository) : base(branchRepository, medicRepository)
        {
        ...
        public async Task<IEnumerable<BondedRequestDto>> GetByFilter(ReportFilterDto filter)
        {
            ...
            var results = data.ToBondedInternDto();
