...
namespace Service.MedicalRecord.Controllers
{
    ...
    public class PriceQuoteController : ControllerBase
    {
        ...
        //public async Task<List<PriceQuoteInfoDto>> GetByFilter(PriceQuoteFilterDto filter)
        //{
        ...
        //[HttpGet("active")]
        ////[Authorize(Policies.Access)]
        //public async Task<List<PriceQuoteInfoDto>> GetActive()
        //{
        ...
        //[HttpGet("{id}")]
        ////[Authorize(Policies.Access)]
        //public async Task<PriceQuoteDto> GetById(string id)
        //{
        //    return await _Service.GetById(Guid.Parse(id));
        //}
        //[HttpPost]
        ////[Authorize(Policies.Create)]
        //public async Task<PriceQuoteInfoDto> Create(PriceQuoteDto expediente)
        //{
        ...
        //public async Task<PriceQuoteInfoDto> Update(PriceQuoteDto expediente)
        //{
        //    expediente.UserId = Guid.NewGuid(); //(Guid)HttpContext.Items["userId"];
        ...
        //{
        //    var file = await _Service.PrinPriceQuoten();
