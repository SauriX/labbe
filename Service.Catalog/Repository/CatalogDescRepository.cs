...
{
    public class CatalogDescRepository<T> : ICatalogDescRepository<T> where T : GenericCatalogDescription
    {
        private readonly ApplicationDbContext _context;
        private readonly DbSet<T> _entity;

        public CatalogDescRepository(ApplicationDbContext context)
        {
            _context = context;
