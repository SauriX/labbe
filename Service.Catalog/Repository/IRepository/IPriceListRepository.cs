...
namespace Service.Catalog.Repository.IRepository
{
    public interface IPriceListRepository
    {
        ...
        Task<PriceList_Study> GetPriceStudyById(int studyId, Guid branchId, Guid? companyId, Guid? doctorId);
        Task<List<PriceList_Study>> GetPriceStudyById(Guid priceListId, IEnumerable<int> studyId);
        Task<PriceList_Packet> GetPricePackById(int packId, Guid branchId, Guid? companyId, Guid? doctorId);
